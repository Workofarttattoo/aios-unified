...
# Display names for CLI
DISPLAY_NAME = "Ai:oS"
DISPLAY_NAME_FULL = "Artificial Intelligence Operating System"
...
DEFAULT_MANIFEST = Manifest(
    meta_agents={
        ...
        "quantum": MetaAgentConfig(
            name="quantum",
            description="Quantum computing virtualization and simulation engine.",
            actions=_actions(
                ...
                ActionConfig("apple_silicon", "Initialize Apple Silicon acceleration.", critical=False),
            ),
        ),
    },
    boot_sequence=[
